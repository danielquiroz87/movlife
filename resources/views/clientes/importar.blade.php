...
<div class="col-md-8 mb-4">
      <div class="card text-left">
          <div class="card-body">
                <h3 class="card-title mb3">Nueva Importación / <a href="/importadores/clientes_movlife.csv" download="clientes_movlife.csv" target="_blank">Archivo Ejemplo</a></h3>
  
 <div class="box box-info">
    <form action="{{route('general.importar.save')}}" method="POST" id="user-new-form" enctype="multipart/form-data" >
    {{ csrf_field() }}
      <input type="hidden" name="id" value="0">
      <input type="hidden" name="model" value="clientes">
