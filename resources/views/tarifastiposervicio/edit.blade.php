...
<div class="col-md-6">
      <div class="card text-left">
          <div class="card-body">
                <h3 class="card-title mb3">Editar Tarifa / Usuario: {{ Auth::user()->name }} </h3>
        ...
        <div class="row">
            ...
            <div class="col-md-12 form-group mb-3">
              <label><strong>Cliente:</strong></label>
                  <select name="cliente_id" id="cliente_id" class="form-control">
                        <?php echo Helper::selectClientes($tarifario->cliente_id) ?>
                    </select>
            </div>
            ...
            <div class="col-md-6 form-group mb-3">
              <label><strong> URI / SEDE:</strong></label>
                  <select name="uri_sede" id="uri_sede" class="form-control">
                        <?php echo Helper::selectSedes($tarifario->uri_sede) ?>
                    </select>
            </div>
            ...
            <div class="col-md-6 form-group mb-3">
              <label><strong>Tipo Servicio:</strong></label>
                  <select name="tipo_servicio" class="form-control">
                        <?php echo Helper::selectTipoServicios($tarifario->tipoServicio->id) ?>
                    </select>
            </div>
            ...
            <div class="col-md-12 form-group mb-3">
              <label><strong>Destino:</strong></label>
                   <input type="text" name="destino" id="destination-input" value="{{$tarifario->destino}}" class="form-control" placeholder="" >
            </div>
